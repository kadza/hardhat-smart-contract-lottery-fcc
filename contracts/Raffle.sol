...
contract Raffle is VRFConsumerBaseV2 {
    ...
    // the maximum gas price you are willing to pay for a request in wei
    ...
    event WinnerPicked(address indexed winnder);
    ...
    //external is slightly cheaper because it can't be called internally
